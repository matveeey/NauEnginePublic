...
if len(sys.argv) < 5:
  print("ERROR: expected 4 arguments.\nUsage: gen_es.py input output rel_path_for_include path_to_meta_file [CHECK]")
  sys.exit(1)

input_file_name = sys.argv[1]
output_file_name = sys.argv[2]
rel_path_for_include = sys.argv[3]
path_to_meta_file = sys.argv[4]
compiler_errors = []
...
resultCode = gen_es(allParsedFunctions, event_handler_suffix, input_file_name, path_to_meta_file)
gets_code = ""
gets_type_code = ""
