...
{
    class UsdKeyFrameAnimationCompiler final : public IAssetCompiler
    {
    public:
    ...
    class UsdSkeletalAnimationCompiler final : public IAssetCompiler
    {
    public:
        std::string_view ext() const override
        {
    ...
    class GltfSkeletalAnimationCompiler final : public IAssetCompiler
    {
    public:
        std::string_view ext() const override
        {
