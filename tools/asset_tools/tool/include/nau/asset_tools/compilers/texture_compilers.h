...
namespace nau
{
    namespace compilers
    {
        class PngAssetCompiler final : public IAssetCompiler
        {
        public:
        ...
        class DdsAssetCompiler final : public IAssetCompiler
        {
        public:
            std::string_view ext() const override
            {
        ...
        class JpgAssetCompiler final : public IAssetCompiler
        {
        public:
            std::string_view ext() const override
            {
