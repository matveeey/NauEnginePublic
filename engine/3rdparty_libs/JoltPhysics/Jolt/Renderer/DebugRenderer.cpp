...
void DebugRenderer::DrawSphere(RMat44Arg inMatrix, float inRadius, ColorArg inColor)
{
	JPH_PROFILE_FUNCTION();

	DrawSphere(inMatrix.GetTranslation(), inRadius, inColor, ECastShadow::Off, EDrawMode::Wireframe);
}
