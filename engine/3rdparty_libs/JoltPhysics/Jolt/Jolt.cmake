...
target_include_directories(Jolt PUBLIC
    ...
    $<INSTALL_INTERFACE:$<INSTALL_PREFIX>/include/3rdPartyLibs/Jolt>
)
...
elseif (DEBUG_RENDERER_IN_DEBUG_AND_RELEASE)
	target_compile_definitions(Jolt PUBLIC "$<$<CONFIG:Debug,Release,RelWithDebInfo,ReleaseASAN,ReleaseUBSAN>:JPH_DEBUG_RENDERER>")
endif()
