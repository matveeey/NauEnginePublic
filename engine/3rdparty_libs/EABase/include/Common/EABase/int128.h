...
namespace eastl
{
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////
    EA_CONSTEXPR inline int128_t_base::operator bool() const
    {
        return mPart0 || mPart1;
    }
    EA_CONSTEXPR inline int128_t_base::operator char() const
    {
...
// EA_CONSTEXPR inline int128_t_base::operator wchar_t() const            { return static_cast<wchar_t>(Low()); }
#endif
    EA_CONSTEXPR inline int128_t_base::operator int() const
    {
        return static_cast<int>(Low());
    }
    EA_CONSTEXPR inline int128_t_base::operator long() const
    {
        return static_cast<long>(Low());
    }
    EA_CONSTEXPR inline int128_t_base::operator long long() const
    {
        return static_cast<long long>(Low());
    }
    EA_CONSTEXPR inline int128_t_base::operator short() const
    {
        return static_cast<short>(Low());
    }
    EA_CONSTEXPR inline int128_t_base::operator signed char() const
    {
        return static_cast<signed char>(Low());
    }
    EA_CONSTEXPR inline int128_t_base::operator unsigned char() const
    {
        return static_cast<unsigned char>(Low());
    }
    EA_CONSTEXPR inline int128_t_base::operator unsigned int() const
    {
        return static_cast<unsigned int>(Low());
    }
    EA_CONSTEXPR inline int128_t_base::operator unsigned long long() const
    {
        return static_cast<unsigned long long>(Low());
    }
    EA_CONSTEXPR inline int128_t_base::operator unsigned long() const
    {
        return static_cast<unsigned long>(Low());
    }
    EA_CONSTEXPR inline int128_t_base::operator unsigned short() const
    {
        return static_cast<unsigned short>(Low());
    }
    EA_CONSTEXPR inline int128_t_base::operator float() const
    {
        return static_cast<float>(Low());
    }
    EA_CONSTEXPR inline int128_t_base::operator double() const
    {
        return static_cast<double>(Low());
    }
    EA_CONSTEXPR inline int128_t_base::operator long double() const
    {
        return static_cast<long double>(Low());
    }
#if EA_INT128_INTRINSIC_AVAILABLE
    EA_CONSTEXPR inline int128_t_base::operator __int128() const
    {
        return static_cast<__int128>(Low());
    }
    EA_CONSTEXPR inline int128_t_base::operator unsigned __int128() const
    {
        return static_cast<unsigned __int128>(Low());
    }
#endif
    ...
    // would work.
    //
    /* EA_CONSTEXPR */ inline uint128_t UINT128_C(uint64_t nPart1, uint64_t nPart0)
    {
        return uint128_t(nPart0, nPart1);
    }
    /* EA_CONSTEXPR */ inline int128_t INT128_C(int64_t nPart1, int64_t nPart0)
    {
        return int128_t(static_cast<uint64_t>(nPart0), static_cast<uint64_t>(nPart1));
    }
