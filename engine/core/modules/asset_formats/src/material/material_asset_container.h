...
namespace nau
{
    /**
     */
    class MaterialAssetContainerLoader final : public IAssetContainerLoader
    {
        NAU_INTERFACE(nau::MaterialAssetContainerLoader, IAssetContainerLoader)

    public:
        MaterialAssetContainerLoader() = default;
