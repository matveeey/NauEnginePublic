...
class NAU_DAGORECS_EXPORT Object
{
public:
  ...
  // data.
  typedef eastl::vector<value_type> container_t;
  typedef eastl::vector<ecs::hash_str_t> hash_container_t;
