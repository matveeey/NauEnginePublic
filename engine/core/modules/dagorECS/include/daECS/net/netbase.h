...
public:
  ...
  virtual void setEncryptionKey(nau::ConstSpan<uint8_t> key, EncryptionKeyBits ebits) = 0;
...
nau::Span<net::IConnection *> get_client_connections(); // Note: might contain NULLs
