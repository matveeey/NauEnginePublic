...
#define SPECIALIZE_MEMCPY_TO_SOA(CSZ, TO, EID, FROM)                          \
  ...
  {                                                                           \
    ...
    case 16: SPECIALIZE_MEMCPY_HELPER(TO, Vectormath::SSE::IVector4, EID, FROM, 1); \
            break;        \
...
#define SPECIALIZE_MEMCPY_IN_SOA2(CSZ, DATA_TO, DATA_FROM, TO, FROM)                                  \
  ...
  {                                                                                                   \
    ...
    case 16: SPECIALIZE_MEMCPY_HELPER_SOA2(DATA_TO, DATA_FROM, Vectormath::SSE::IVector4, TO, FROM, 1); \
            break;            \
...
#define SPECIALIZE_MEMCPY(CSZ, TO, FROM)                                            \
  ...
  {                                                                                 \
    ...
    case 16: SPECIALIZE_MEMCPY_HELPER2(TO, Vectormath::SSE::IVector4, FROM, 1); \
            break;                  \
