...
eastl::vector<replicate_component_filter_index_t> replicate_component_filter_index; // we use eastl::vector, as it's size() is faster.
eastl::vector<component_replication_filter> replicate_component_filters;
