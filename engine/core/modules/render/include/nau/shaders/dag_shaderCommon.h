...
struct ShaderChannelId
{
  ...
  // val=(val+offset)*mul
  static void setPosBounding(const nau::math::Point3 &offset, const nau::math::Point3 &mul);
  static void getPosBounding(nau::math::Point3 &offset, nau::math::Point3 &mul);
...
struct Color4;
typedef eastl::span<Color4> *VprArrayPtr;
