...
NAU_RENDER_EXPORT unsigned int get_d3d_reset_counter();  // returns current reset generation, never 0
...
struct D3dResetQueue
{
  ...
  NAU_RENDER_EXPORT static D3dResetQueue *tailBeforeReset, *tailAfterReset;
