...
extern void NAU_RENDER_EXPORT d3d_get_render_target(Driver3dRenderTarget &rt);
extern void NAU_RENDER_EXPORT d3d_set_render_target(Driver3dRenderTarget &rt);

extern void NAU_RENDER_EXPORT d3d_get_view_proj(ViewProjMatrixContainer &vp);
extern void NAU_RENDER_EXPORT d3d_set_view_proj(const ViewProjMatrixContainer &vp);

extern void NAU_RENDER_EXPORT d3d_get_view(int &viewX, int &viewY, int &viewW, int &viewH, float &viewN, float &viewF);
extern void NAU_RENDER_EXPORT d3d_set_view(int viewX, int viewY, int viewW, int viewH, float viewN, float viewF);
...
public:
  ...
  friend bool operator==(const Driver3dRenderTarget &l, const Driver3dRenderTarget &r)
  {
    ...
    for (auto i : nau::math::LsbVisitor{l.used & Driver3dRenderTarget::COLOR_MASK})
...
struct ViewProjMatrixContainer
{
  const nau::math::Matrix4 &getViewTm() const { return savedView; }
  const nau::math::Matrix4 &getProjTm() const { return savedProj; }

  nau::math::Matrix4 savedView = nau::math::Matrix4::identity();
  nau::math::Matrix4 savedProj = nau::math::Matrix4::identity();
