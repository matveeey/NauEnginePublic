...
constexpr BinaryOp<Inverted<T>, T1, OpAnd> operator&&(const Inverted<T> &l, const T1 &r)
{
  return {l, r};
}
...
template <typename T, typename T1>
constexpr BinaryOp<Inverted<T>, T1, OpOr> operator||(const Inverted<T> &l, const T1 &r)
{
  return {l, r};
}
//! Logical and operator, allows combining multiple matchers.
...
constexpr BinaryOp<BinaryOp<T0, T1, Operator>, TO, OpAnd> operator&&(const BinaryOp<T0, T1, Operator> &l, const TO &r)
{
  return {l, r};
}
//! Logical or operator, allows combining multiple matchers.
...
//! \returns A new BinaryOp type of this type and \p T1 with an operator OpOr.
template <typename T0, typename T1, typename Operator, typename TO>
constexpr BinaryOp<BinaryOp<T0, T1, Operator>, TO, OpOr> operator||(const BinaryOp<T0, T1, Operator> &l, const TO &r)
{
  return {l, r};
}
//! Logical and operator, allows combining multiple matchers.
...
constexpr BinaryOp<ID<Ident>, T1, OpAnd> operator&&(const ID<Ident> &l, const T1 &r)
{
  return {l, r};
}
//! Logical or operator, allows combining multiple matchers.
...
//! \returns A new BinaryOp type of this type and \p T1 with an operator OpOr.
template <int Ident, typename T1>
constexpr BinaryOp<ID<Ident>, T1, OpOr> operator||(const ID<Ident> &l, const T1 &r)
{
  return {l, r};
}
//! Logical and operator, allows combining multiple matchers.
