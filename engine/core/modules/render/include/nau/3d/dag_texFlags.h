...
enum TEXFMT
{
  ...
  TEXCF_SIMULTANEOUS_MULTI_QUEUE_USE = 0x00000008U,
  ...
  TEXFMT_A8L8 = 0x16000000U,           // dx9, PS4
  ...
  // should go in a row
  TEXFMT_DEPTH24 = 0x26000000U,
  TEXFMT_DEPTH16 = 0x27000000U,
  TEXFMT_DEPTH32 = 0x28000000U,
  TEXFMT_DEPTH32_S8 = 0x29000000U,
...
{
  return (nau::math::get_log2i(sample_count) << TEXCF_SAMPLECOUNT_OFFSET) & TEXCF_SAMPLECOUNT_MASK;
}