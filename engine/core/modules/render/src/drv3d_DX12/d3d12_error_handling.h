  ...
  int DAGOR_HAS_LOGS(line))
{
  ...
  if ('\0' == resultStr[0])
  {
    NAU_LOG_ERROR("{} returned unknown return code {}, {} {}", expr, result, file, line);
  }
  else
  {
    NAU_LOG_ERROR("{} returned {}, {} {}", expr, resultStr, file, line);
  }
  ...
  int DAGOR_HAS_LOGS(line))
{
  ...
  if ('\0' == resultStr[0])
  {
    NAU_LOG_DEBUG("{} returned unknown return code {}, {} {}", expr, result, file, line);
  }
  else
  {
    NAU_LOG_DEBUG("{} returned {}, {} {}", expr, resultStr, file, line);
  }
...
{
    // TODO: fix it
  //NAU_LOG_ERROR("DX12: Error while querying resource allocation info, resource desc: {}, {}, {} x {} x {}, {}, {}, {} by {}, {}, {:08x}",
