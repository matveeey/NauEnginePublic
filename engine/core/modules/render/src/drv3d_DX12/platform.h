...
struct Direct3D12Enviroment
{
  ...
  bool setup()
  {
    ...
    if (!d3d12Lib)
    {
      NAU_LOG_DEBUG("DX12: Direct3D12Enviroment::setup: Unable to load d3d12.dll");
      teardown();
      return false;
    }
    ...
    if (!dxgiLib)
    {
      NAU_LOG_DEBUG("DX12: Direct3D12Enviroment::setup: Unable to load dxgi.dll");
      teardown();
      return false;
    }
    ...
    {
      NAU_LOG_DEBUG("DX12: Direct3D12Enviroment::setup: d3d12.dll does not exports D3D12CreateDevice");
      return false;
    }
    ...
    {
      NAU_LOG_DEBUG("DX12: Direct3D12Enviroment::setup: d3d12.dll does not exports "
    ...
    {
      NAU_LOG_DEBUG("DX12: Direct3D12Enviroment::setup: dxgi.dll does not export CreateDXGIFactory2");
      return false;
    }
