...
DECL_FORMAT_TRAIT(DXGI_FORMAT_R9G9B9E5_SHAREDEXP, FormatClass::BIT_32, CHANNEL_MASK_RGB);
...
DECL_FORMAT_TRAIT(DXGI_FORMAT_B4G4R4A4_UNORM, FormatClass::BIT_16, CHANNEL_MASK_RGBA);
/*
