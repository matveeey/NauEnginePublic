...
inline constexpr uint32_t FRAME_LATENCY = 3;
...
inline constexpr uint32_t MIN_COMPUTE_CONST_REGISTERS = (1 << 7);
inline constexpr uint32_t VERTEX_SHADER_MAX_REGISTERS = 4096;
inline constexpr uint32_t VERTEX_SHADER_MIN_REGISTERS = 64;
inline constexpr uint32_t PIXEL_SHADER_REGISTERS = 128;
} // namespace drv3d_dx12