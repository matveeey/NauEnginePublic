...
bool drv3d_dx12::pipeline::InputLayoutDeEncoder::decodeDX12(const nau::DataBlock &blk, InputLayout &target) const
{
  if (auto vertexAttributeSetBlk = blk.getBlockByName("vertexAttributeSet"))
  {
    ...
    auto count = Vectormath::min<uint32_t>(MAX_SEMANTIC_INDEX, vertexAttributeSetBlk->blockCount());
...
bool drv3d_dx12::pipeline::InputLayoutDeEncoder::decodeEngine(const nau::DataBlock &blk, InputLayout &target) const
{
...
bool drv3d_dx12::pipeline::InputLayoutDeEncoder::decode(const nau::DataBlock &blk, InputLayout &target) const
{
...
bool drv3d_dx12::pipeline::InputLayoutDeEncoder::encode(nau::DataBlock &blk, const InputLayout &source) const
{
...
bool drv3d_dx12::pipeline::RenderStateDeEncoder::decodeDX12(const nau::DataBlock &blk, RenderStateSystem::StaticState &target) const
{
  ...
  {
    auto blendParamsBlkCount = Vectormath::min<uint32_t>(blendParamsBlk->blockCount(), shaders::RenderState::NumIndependentBlendParameters);
...
bool drv3d_dx12::pipeline::RenderStateDeEncoder::decodeEngine(const nau::DataBlock &blk, shaders::RenderState &target) const
{
...
bool drv3d_dx12::pipeline::RenderStateDeEncoder::decode(const nau::DataBlock &blk, RenderStateSystem::StaticState &target) const
{
  if (0 == strcmp("dx12", blk.getStr("fmt", defaultFormat)))
  {
    return decodeDX12(blk, target);
...
bool drv3d_dx12::pipeline::RenderStateDeEncoder::encode(nau::DataBlock &blk, const RenderStateSystem::StaticState &source) const
{
...
bool drv3d_dx12::pipeline::FramebufferLayoutDeEncoder::decodeDX12(const nau::DataBlock &blk, FramebufferLayout &target) const
{
...
bool drv3d_dx12::pipeline::FramebufferLayoutDeEncoder::decodeEngine(const nau::DataBlock &blk, FramebufferLayout &target) const
{
  auto formatNameId = blk.getNameId("colorFormats");
  if ((-1 != formatNameId) && blk.paramExists(formatNameId))
  {
...
bool drv3d_dx12::pipeline::FramebufferLayoutDeEncoder::decode(const nau::DataBlock &blk, FramebufferLayout &target) const
{
  if (0 == strcmp("dx12", blk.getStr("fmt", defaultFormat)))
  {
    return decodeDX12(blk, target);
...
bool drv3d_dx12::pipeline::FramebufferLayoutDeEncoder::encode(nau::DataBlock &blk, const FramebufferLayout &source) const
{
...
bool drv3d_dx12::pipeline::DeviceCapsAndShaderModelDeEncoder::decode(const nau::DataBlock &blk, EncodingMode mode,
...
bool drv3d_dx12::pipeline::DeviceCapsAndShaderModelDeEncoder::encode(nau::DataBlock &blk, EncodingMode mode,
...
bool drv3d_dx12::pipeline::FeatureSupportResolver::decode(const nau::DataBlock &blk, CompatibilityMode mode, bool &target) const
{
...
bool drv3d_dx12::pipeline::FeatureSetChecker::checkFeatureSets(const nau::DataBlock &blk) const
{
  if (!featureSet)
  {
    return true;
...
bool drv3d_dx12::pipeline::GraphicsPipelineVariantDeEncoder::decode(const nau::DataBlock &blk, GraphicsPipelineVariantState &target) const
{
...
bool drv3d_dx12::pipeline::GraphicsPipelineVariantDeEncoder::encode(nau::DataBlock &blk, const GraphicsPipelineVariantState &source) const
{
...
bool drv3d_dx12::pipeline::MeshPipelineVariantDeEncoder::decode(const nau::DataBlock &blk, MeshPipelineVariantState &target) const
{
  if (!checkFeatureSets(blk))
  {
    return false;
...
bool drv3d_dx12::pipeline::MeshPipelineVariantDeEncoder::encode(nau::DataBlock &blk, const MeshPipelineVariantState &source) const
{
  blk.setInt("renderState", source.staticRenderStateIndex);
  blk.setInt("outputFormat", source.framebufferLayoutIndex);
  blk.setBool("wireFrame", 0 != source.isWireFrame);
...
bool drv3d_dx12::pipeline::ComputePipelineDeEncoder::decode(const nau::DataBlock &blk, ComputePipelineIdentifier &target) const
{
  if (!checkFeatureSets(blk))
  {
    return false;
...
bool drv3d_dx12::pipeline::ComputePipelineDeEncoder::encode(nau::DataBlock &blk, const ComputePipelineIdentifier &source) const
{
