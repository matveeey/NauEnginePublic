...
#include "drv3d_DX12/driver.h"
#include "drv3d_DX12/pipeline.h"
#include "drv3d_DX12/winapi_helpers.h"
...
class Aftermath
{
  ...
  dag::CriticalSection crashWriteMutex;
...
public:
  ...
  ~Aftermath()
  {
    ...
    {
      NAU_LOG_DEBUG("DX12: Shutting down NVIDIA Aftermath API");
  ...
  static bool load(const Configuration &config, const Direct3D12Enviroment &, T &target)
  {
    ...
    {
      NAU_LOG_DEBUG("DX12: NVIDIA Aftermath is disabled by configuration...");
      return false;
    }
    NAU_LOG_DEBUG("DX12: Loading NVIDIA Aftermath library...");
    ...
    NAU_LOG_DEBUG("DX12: ...loading NVIDIA Aftermath API...");
    ...
    NAU_LOG_DEBUG("DX12: ...using NVIDIA Aftermath API for GPU postmortem trace");
    return true;
  }
};
} // namespace drv3d_dx12::debug::gpu_postmortem::nvidia
