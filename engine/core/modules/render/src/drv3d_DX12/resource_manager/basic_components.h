...
protected:
  ...
  nau::threading::SpinLock recodingPendingFrameCompletionMutex;
...
protected:
  ...
  bool checkForOOM(bool was_okay, Args &&...args)
  {
    ...
    NAU_ASSERT(was_okay, eastl::forward<Args>(args)...);
    return was_okay;
  }
...
protected:
  using ConcurrentMetricsState = ContainerMutexWrapper<MetricsState, dag::CriticalSection>;
...
protected:
  dag::CriticalSection *getMetrixMutex() { return nullptr; }
  ...
  void recordBufferHeapAllocated(uint32_t, bool, const char8_t *) {}
  void recordBufferHeapFreed(uint32_t, bool, const char *) {}
  void recordTextureAllocated(MipMapCount, ArrayLayerCount, const Extent3D &, uint32_t, FormatStore, const char8_t *) {}
  void recordTextureAliased(MipMapCount, ArrayLayerCount, const Extent3D &, FormatStore, const char8_t *) {}
  void recordTextureAdopted(MipMapCount, ArrayLayerCount, const Extent3D &, FormatStore, const char8_t *) {}
  ...
  void recordTexturePlacedInUserResourceHeap(MipMapCount, ArrayLayerCount, const Extent3D &, uint32_t, FormatStore, const char8_t *) {}
  void recordBufferPlacedInUserResouceHeap(uint32_t, bool, const char8_t *) {}
  // void setup(const SetupInfo &) {}
  // void shutdown() {}
  // void preRecovery() {}
  // void completeFrameRecording(const CompletedFrameRecordingInfo &) {}
...
class GlobalSubresourceIdProvider : public MetricsProvider
{
  ...
  ContainerMutexWrapper<GlobalSubresourceIdProviderState, nau::threading::SpinLock> idProviderState;
