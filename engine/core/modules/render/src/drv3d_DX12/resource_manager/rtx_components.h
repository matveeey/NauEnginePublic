...
protected:
  ...
  ContainerMutexWrapper<BasicBuffer, nau::threading::SpinLock> scratchBuffer;
...
protected:
  ContainerMutexWrapper<ObjectPool<RaytraceAccelerationStructure>, nau::threading::SpinLock> raytraceAccelerationStructurePool;
