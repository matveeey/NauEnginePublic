...
private:
  ...
  void resizeTexture(intermediate::ResourceIndex res_idx, int frame, const nau::math::Vector2 &resolution);
...
private:
  ...
  struct ResourceKey
  {
    ...
    ResourceKey(const ResourceKey &key, const nau::math::Vector2 &resolution);
  ...
  eastl::vector<PlaceProperty> placedProperties;
