...
#include "dabfg/id/idSentinels.h"
...
struct Graph
{
  ...
  // NAU_LOG_ERRORs in debug build if state is inconsistent
...
private:
  ...
  eastl::vector<NodeIndex> nodeNameIdMapping_{};
  eastl::vector<ResourceIndex> resNameIdMapping_{};
};
