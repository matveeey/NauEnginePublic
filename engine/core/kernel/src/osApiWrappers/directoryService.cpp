...
namespace nau::hal
{
    ...
    extern "C" bool dd_rename(const char* oldname, const char* newname)
    {
        ...
        return iterate_base_paths2(oldname, newname, [](const char* ofn, const char* nfn)
        {
            return rename_internal(ofn, nfn);
        });
    }
    ...
    extern "C" bool dd_mkdir(const char* filename)
    {
        ...
        return iterate_base_paths_l(filename, [](char* fn, int base_len)
        {
            return mkdirRecursive(fn, base_len);
        });
    }
    ...
    extern "C" bool dd_file_exist(const char* filename)
    {
        ...
        */
        ...
        return iterate_base_paths_fast(filename, [](const char* fn)
        {
            return check_file_exists(fn);
        });
    }
