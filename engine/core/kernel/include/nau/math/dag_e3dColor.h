...
#define E3DCOLOR_MAKE(r, g, b, a) ((nau::math::E3DCOLOR)(((a) << 24) | ((r) << 16) | ((g) << 8) | (b)))
#define E3DCOLOR_MAKE_SWAPPED(r, g, b, a) ((nau::math::E3DCOLOR)(((a) << 24) | ((b) << 16) | ((g) << 8) | (r)))
...
namespace nau::math
{
    ...
    inline float brightness(E3DCOLOR c)
    {
        return (c.r * .299f + c.g * .587f + c.b * .114) / 255.0f;
    }
